...
Reading layer `ne_50m_lakes' from data source 
  `C:\Users\corre\AppData\Local\Temp\Rtmp0Ayz4t\ne_50m_lakes.shp' 
...
::: {.cell-output-display}
![](images/summary-1.pdf){width=768}
:::
...
\toprule
\em{Group} & \em{variable} & \em{n} & \em{mean} & \em{sd} & \em{median} & \em{iqr}\\
\midrule
\endfirsthead
...
Proportion of total variation (explained variance): 0.9994562
```
:::

::: {.cell-output-display}
![](images/multi outliers-1.pdf){width=672}
:::
:::
...
kbl(mshapiro_results, digits = c(0, 3, 10), format = "latex",
...
\caption{\label{tab:multi normality}Multinormality tests}
\centering
\begin{tabular}[t]{lrrl}
\toprule
\em{Group} & \em{statistic} & \em{p.value} & \em{method}\\
\midrule
...
::: {.cell-output-display}
![](images/multi normality-1.pdf){width=576}
:::
:::
...
kbl(uni_normal, digits = c(3, 3), format = "latex", booktabs = TRUE,
...
\caption{\label{tab:uni normality}Uninormality tests}\\
\toprule
\em{variable} & \em{Group} & \em{statistic} & \em{p.value} & \em{method}\\
\midrule
\endfirsthead
\caption[]{Uninormality tests \textit{(continued)}}\\
\toprule
\em{variable} & \em{Group} & \em{statistic} & \em{p.value} & \em{method}\\
\midrule
\endhead
...
\cellcolor{gray!6}{\textbf{HAsfc}} & \cellcolor{gray!6}{\textbf{Turkana}} & \cellcolor{gray!6}{\textbf{0.650}} & \cellcolor{gray!6}{\textbf{0.001}} & \cellcolor{gray!6}{\textbf{Shapiro-Wilk normality test}}\\
...
\cellcolor{gray!6}{\textbf{Sp}} & \cellcolor{gray!6}{\textbf{Luo (Port Vict.)}} & \cellcolor{gray!6}{\textbf{0.626}} & \cellcolor{gray!6}{\textbf{0.000}} & \cellcolor{gray!6}{\textbf{Shapiro-Wilk normality test}}\\
\addlinespace
...
\cellcolor{gray!6}{\textbf{Sz}} & \cellcolor{gray!6}{\textbf{Turkana}} & \cellcolor{gray!6}{\textbf{0.608}} & \cellcolor{gray!6}{\textbf{0.000}} & \cellcolor{gray!6}{\textbf{Shapiro-Wilk normality test}}\\
Sz & Luhya (Webuye) & 0.822 & 0.067 & Shapiro-Wilk normality test\\
Sz & Luhya (Port Vict.) & 0.941 & 0.670 & Shapiro-Wilk normality test\\
\cellcolor{gray!6}{\textbf{Sz}} & \cellcolor{gray!6}{\textbf{Luo (Port Vict.)}} & \cellcolor{gray!6}{\textbf{0.688}} & \cellcolor{gray!6}{\textbf{0.002}} & \cellcolor{gray!6}{\textbf{Shapiro-Wilk normality test}}\\
\addlinespace
...
\caption{\label{tab:multi homocedasticity}Covariance matrix for the El Molo}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:multi homocedasticity}Covariance matrix for the Turkana}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrrrrrrrr}
\toprule
...
\caption{\label{tab:multi homocedasticity}Covariance matrix for the Luhya (Webuye)}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrrrrrrrr}
\toprule
...
\caption{\label{tab:multi homocedasticity}Covariance matrix for the Luhya (Port Vict.)}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrrrrrrrr}
\toprule
...
\caption{\label{tab:multi homocedasticity}Covariance matrix for the Luo (Port Vict.)}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrrrrrrrrr}
\toprule
...
kbl(uni_homocedast, digits = c(0, 0, 0, 3, 3), format = "latex",
...
\caption{\label{tab:uni homocedasticity}Unihomocedasticity tests}
\centering
\begin{tabular}[t]{lrrrr}
\toprule
\em{variable} & \em{df1} & \em{df2} & \em{statistic} & \em{p}\\
\midrule
...
\caption{\label{tab:permanova}Permanova Results with 999 permutations}
\centering
\begin{tabular}[t]{lrrrrrr}
\toprule
\em{ } & \em{Sum Sq} & \em{Mean Sq} & \em{Df} & \em{F} & \em{p-value} & \em{partialEta2}\\
\midrule
Group & 1,040,145,654 & 260,036,413 & 4 & 3.814 & 0.013 & 0.323\\
...
kbl(pairwisePermanova, format = "latex", booktabs = TRUE, caption = pairwise_permanova$method) |>
    kable_styling(latex_options = c("hold_position")) |>
    row_spec(color.me, bold = TRUE, background = "gray!6") |>
    row_spec(0, italic = TRUE)
```
...
\caption{\label{tab:permanova post hoc}permutation MANOVAs on a distance matrix}
\centering
\begin{tabular}[t]{lllll}
\toprule
\em{group1} & \em{group2} & \em{statistic(pseudo-F)} & \em{adjusted p-value} & \em{R2}\\
\midrule
\cellcolor{gray!6}{\textbf{El Molo}} & \cellcolor{gray!6}{\textbf{Turkana}} & \cellcolor{gray!6}{\textbf{9.209}} & \cellcolor{gray!6}{\textbf{0.04}} & \cellcolor{gray!6}{\textbf{0.397}}\\
El Molo & Luhya (Webuye) & 0.95 & 0.474 & 0.064\\
El Molo & Luhya (Port Vict.) & 0.294 & 0.716 & 0.022\\
\cellcolor{gray!6}{\textbf{El Molo}} & \cellcolor{gray!6}{\textbf{Luo (Port Vict.)}} & \cellcolor{gray!6}{\textbf{8.136}} & \cellcolor{gray!6}{\textbf{0.04}} & \cellcolor{gray!6}{\textbf{0.352}}\\
Turkana & Luhya (Webuye) & 3.453 & 0.165 & 0.223\\
\addlinespace
\cellcolor{gray!6}{\textbf{Turkana}} & \cellcolor{gray!6}{\textbf{Luhya (Port Vict.)}} & \cellcolor{gray!6}{\textbf{6.484}} & \cellcolor{gray!6}{\textbf{0.04}} & \cellcolor{gray!6}{\textbf{0.371}}\\
Turkana & Luo (Port Vict.) & 0.007 & 0.93 & 0.001\\
Luhya (Webuye) & Luhya (Port Vict.) & 0.228 & 0.716 & 0.02\\
Luhya (Webuye) & Luo (Port Vict.) & 3.079 & 0.165 & 0.192\\
Luhya (Port Vict.) & Luo (Port Vict.) & 5.017 & 0.05 & 0.295\\
\bottomrule
\end{tabular}
\end{table}
:::
...
kbl(merged_data, digits = c(3, 3, 0, 3, 3), format = "latex",
...
\caption{\label{tab:followup ANOVA}Univariate Kruskal-Wallis}
\centering
\begin{tabular}[t]{lrrrrlrl}
\toprule
\em{variable} & \em{n} & \em{df} & \em{statistic (H)} & \em{adjusted p-value} & \em{method} & \em{eta-squared} & \em{magnitude}\\
\midrule
...
\cellcolor{gray!6}{\textbf{Ssk}} & \cellcolor{gray!6}{\textbf{37}} & \cellcolor{gray!6}{\textbf{4}} & \cellcolor{gray!6}{\textbf{23.072}} & \cellcolor{gray!6}{\textbf{0.001}} & \cellcolor{gray!6}{\textbf{Kruskal-Wallis}} & \cellcolor{gray!6}{\textbf{0.596}} & \cellcolor{gray!6}{\textbf{large}}\\
...
kbl(merged_data_effsize, digits = c(3, 3, 3, 3, 3, 3), format = "latex",
...
\caption{\label{tab:followup pairwise}Pairwise comparisons for Ssk using Dunn's test}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{llrrrrl}
\toprule
\em{group1} & \em{group2} & \em{mean difference} & \em{statistic (z)} & \em{adjusted p-value} & \em{hedge's g} & \em{magnitude}\\
\midrule
El Molo & Turkana & -9.048 & -1.659 & 0.162 & 1.238 & large\\
El Molo & Luhya (Webuye) & -9.333 & -1.711 & 0.162 & 1.041 & large\\
\cellcolor{gray!6}{\textbf{El Molo}} & \cellcolor{gray!6}{\textbf{Luhya (Port Vict.)}} & \cellcolor{gray!6}{\textbf{-16.000}} & \cellcolor{gray!6}{\textbf{-2.805}} & \cellcolor{gray!6}{\textbf{0.019}} & \cellcolor{gray!6}{\textbf{1.611}} & \cellcolor{gray!6}{\textbf{large}}\\
\cellcolor{gray!6}{\textbf{El Molo}} & \cellcolor{gray!6}{\textbf{Luo (Port Vict.)}} & \cellcolor{gray!6}{\textbf{-24.333}} & \cellcolor{gray!6}{\textbf{-4.626}} & \cellcolor{gray!6}{\textbf{0.000}} & \cellcolor{gray!6}{\textbf{2.329}} & \cellcolor{gray!6}{\textbf{large}}\\
Turkana & Luhya (Webuye) & -0.286 & -0.049 & 0.961 & -0.046 & negligible\\
\addlinespace
Turkana & Luhya (Port Vict.) & -6.952 & -1.154 & 0.298 & 0.740 & moderate\\
\cellcolor{gray!6}{\textbf{Turkana}} & \cellcolor{gray!6}{\textbf{Luo (Port Vict.)}} & \cellcolor{gray!6}{\textbf{-15.286}} & \cellcolor{gray!6}{\textbf{-2.729}} & \cellcolor{gray!6}{\textbf{0.019}} & \cellcolor{gray!6}{\textbf{1.588}} & \cellcolor{gray!6}{\textbf{large}}\\
Luhya (Webuye) & Luhya (Port Vict.) & -6.667 & -1.107 & 0.298 & 0.718 & moderate\\
\cellcolor{gray!6}{\textbf{Luhya (Webuye)}} & \cellcolor{gray!6}{\textbf{Luo (Port Vict.)}} & \cellcolor{gray!6}{\textbf{-15.000}} & \cellcolor{gray!6}{\textbf{-2.678}} & \cellcolor{gray!6}{\textbf{0.019}} & \cellcolor{gray!6}{\textbf{1.529}} & \cellcolor{gray!6}{\textbf{large}}\\
...
::: {.cell-output-display}
![](images/followup pairwise-1.pdf){width=672}
:::
:::
...
loaded via a namespace (and not attached):
 [1] DBI_1.2.0               gridExtra_2.3           sandwich_3.1-0         
...
[19] rmarkdown_2.25          tzdb_0.4.0              xfun_0.41              
[22] jsonlite_1.8.8          terra_1.7-65            parallel_4.3.1         
[25] cluster_2.1.4           R6_2.5.1                stringi_1.8.3          
[28] estimability_1.4.1      Rcpp_1.0.11             knitr_1.45             
[31] zoo_1.8-12              parameters_0.21.3       base64enc_0.1-3        
[34] Matrix_1.6-4            splines_4.3.1           timechange_0.2.0       
[37] tidyselect_1.2.0        rstudioapi_0.15.0       abind_1.4-5            
[40] yaml_2.3.8              codetools_0.2-19        plyr_1.8.9             
[43] bayestestR_0.13.1       withr_2.5.2             evaluate_0.23          
[46] survival_3.5-5          sf_1.0-14               rnaturalearthdata_0.1.0
[49] units_0.8-4             proxy_0.4-27            xml2_1.3.6             
[52] pillar_1.9.0            KernSmooth_2.23-21      stats4_4.3.1           
[55] insight_0.19.7          pcaPP_2.0-4             generics_0.1.3         
[58] sp_2.1-2                hms_1.1.3               munsell_0.5.0          
[61] scales_1.3.0            xtable_1.8-4            class_7.3-22           
[64] glue_1.6.2              emmeans_1.9.0           tools_4.3.1            
[67] webshot_0.5.5           ggsignif_0.6.4          mvtnorm_1.2-4          
[70] rgl_1.2.8               grid_4.3.1              datawizard_0.9.1       
[73] colorspace_2.1-0        nlme_3.1-162            cli_3.6.1              
[76] fansi_1.0.5             viridisLite_0.4.2       svglite_2.1.3          
[79] gtable_0.3.4            DEoptimR_1.1-3          digest_0.6.33          
[82] classInt_0.4-10         TH.data_1.1-2           farver_2.1.1           
[85] htmlwidgets_1.6.4       htmltools_0.5.7         lifecycle_1.0.4        
