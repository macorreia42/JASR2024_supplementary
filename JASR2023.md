...
##   `C:\Users\corre\AppData\Local\Temp\RtmpuCF8g0\ne_50m_lakes.shp' 
...
## Proportion of total variation (explained variance): 0.9994717
```

![](images/multi outliers-1.pdf)<!-- -->
...
\midrule
Group & 1,040,145,654 & 260,036,413 & 4 & 3.814 & 0.008 & 0.323\\
...
\midrule
\cellcolor{gray!6}{\textbf{El Molo}} & \cellcolor{gray!6}{\textbf{Turkana}} & \cellcolor{gray!6}{\textbf{9.209}} & \cellcolor{gray!6}{\textbf{0.037}} & \cellcolor{gray!6}{\textbf{0.397}}\\
El Molo & Luhya (Webuye) & 0.95 & 0.467 & 0.064\\
El Molo & Luhya (Port Vict.) & 0.294 & 0.672 & 0.022\\
\cellcolor{gray!6}{\textbf{El Molo}} & \cellcolor{gray!6}{\textbf{Luo (Port Vict.)}} & \cellcolor{gray!6}{\textbf{8.136}} & \cellcolor{gray!6}{\textbf{0.037}} & \cellcolor{gray!6}{\textbf{0.352}}\\
Turkana & Luhya (Webuye) & 3.453 & 0.165 & 0.223\\
\addlinespace
\cellcolor{gray!6}{\textbf{Turkana}} & \cellcolor{gray!6}{\textbf{Luhya (Port Vict.)}} & \cellcolor{gray!6}{\textbf{6.484}} & \cellcolor{gray!6}{\textbf{0.037}} & \cellcolor{gray!6}{\textbf{0.371}}\\
Turkana & Luo (Port Vict.) & 0.007 & 0.938 & 0.001\\
Luhya (Webuye) & Luhya (Port Vict.) & 0.228 & 0.672 & 0.02\\
Luhya (Webuye) & Luo (Port Vict.) & 3.079 & 0.165 & 0.192\\
Luhya (Port Vict.) & Luo (Port Vict.) & 5.017 & 0.065 & 0.295\\
\bottomrule
\end{tabular}
\end{table}
...
![](images/followup pairwise-1.pdf)<!-- -->
