...
knitr::opts_chunk$set(
  ...
  fig.path = "images/",
  dev = c("svg", "png"), #saves figures as pdf and png in images folder
...
##   `C:\Users\corre\AppData\Local\Temp\RtmpKYDL4b\ne_50m_lakes.shp' 
...
<caption>summary statistics</caption>
 <thead>
  <tr>
   <th style="text-align:left;font-style: italic;"> Group </th>
   <th style="text-align:left;font-style: italic;"> variable </th>
   <th style="text-align:right;font-style: italic;"> n </th>
   <th style="text-align:right;font-style: italic;"> mean </th>
   <th style="text-align:right;font-style: italic;"> sd </th>
   <th style="text-align:right;font-style: italic;"> median </th>
   <th style="text-align:right;font-style: italic;"> iqr </th>
  </tr>
 </thead>
<tbody>
  <tr>
...
## Proportion of total variation (explained variance): 0.9994894
```
...
<caption>Multinormality tests</caption>
 <thead>
  <tr>
   <th style="text-align:left;font-style: italic;"> Group </th>
   <th style="text-align:right;font-style: italic;"> statistic </th>
   <th style="text-align:right;font-style: italic;"> p.value </th>
   <th style="text-align:left;font-style: italic;"> method </th>
  </tr>
 </thead>
<tbody>
  <tr>
...
<caption>Unihomocedasticity tests</caption>
 <thead>
  <tr>
   <th style="text-align:left;font-style: italic;"> variable </th>
   <th style="text-align:right;font-style: italic;"> df1 </th>
   <th style="text-align:right;font-style: italic;"> df2 </th>
   <th style="text-align:right;font-style: italic;"> statistic </th>
   <th style="text-align:right;font-style: italic;"> p </th>
  </tr>
 </thead>
<tbody>
  <tr>
...
<caption>Permanova Results with 999 permutations</caption>
 <thead>
  <tr>
   ...
   <th style="text-align:right;font-style: italic;"> Sum Sq </th>
   <th style="text-align:right;font-style: italic;"> Mean Sq </th>
   <th style="text-align:right;font-style: italic;"> Df </th>
   <th style="text-align:right;font-style: italic;"> F </th>
   <th style="text-align:right;font-style: italic;"> p-value </th>
   <th style="text-align:right;font-style: italic;"> partialEta2 </th>
  </tr>
 </thead>
<tbody>
  <tr>
...
<caption>permutation MANOVAs on a distance matrix</caption>
 <thead>
  <tr>
   <th style="text-align:left;font-style: italic;"> group1 </th>
   <th style="text-align:left;font-style: italic;"> group2 </th>
   <th style="text-align:left;font-style: italic;"> statistic(pseudo-F) </th>
   <th style="text-align:left;font-style: italic;"> adjusted p-value </th>
   <th style="text-align:left;font-style: italic;"> R2 </th>
  </tr>
 </thead>
<tbody>
  <tr>
   ...
   <td style="text-align:left;font-weight: bold;background-color: gray!6 !important;"> 0.047 </td>
...
<caption>Univariate Kruskal-Wallis</caption>
 <thead>
  <tr>
   ...
   <th style="text-align:right;font-style: italic;"> n </th>
   <th style="text-align:right;font-style: italic;"> df </th>
   <th style="text-align:right;font-style: italic;"> statistic (H) </th>
   <th style="text-align:right;font-style: italic;"> adjusted p-value </th>
   <th style="text-align:left;font-style: italic;"> method </th>
   <th style="text-align:right;font-style: italic;"> eta-squared </th>
   <th style="text-align:left;font-style: italic;"> magnitude </th>
  </tr>
 </thead>
<tbody>
  <tr>
...
<caption>Pairwise comparisons for Ssk using Dunn's test</caption>
 <thead>
  <tr>
   <th style="text-align:left;font-style: italic;"> group1 </th>
   <th style="text-align:left;font-style: italic;"> group2 </th>
   <th style="text-align:right;font-style: italic;"> mean difference </th>
   <th style="text-align:right;font-style: italic;"> statistic (z) </th>
   <th style="text-align:right;font-style: italic;"> adjusted p-value </th>
   <th style="text-align:right;font-style: italic;"> hedge's g </th>
   <th style="text-align:left;font-style: italic;"> magnitude </th>
  </tr>
 </thead>
<tbody>
